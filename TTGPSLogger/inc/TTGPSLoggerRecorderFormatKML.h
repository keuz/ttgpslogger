 ...
 */
#ifndef TTGPSLOGGERRECORDERFORMATKML_H
#define TTGPSLOGGERRECORDERFORMATKML_H
...
class CTTGPSLoggerRecorderFormatKML : public CBase, public MTTGPSLoggerRecorderFormat
	{
public:
    static CTTGPSLoggerRecorderFormatKML* NewL(CTTGPSLoggerEngine* aEngine);
    static CTTGPSLoggerRecorderFormatKML* NewLC(CTTGPSLoggerEngine* aEngine);
	~CTTGPSLoggerRecorderFormatKML();

private:
    CTTGPSLoggerRecorderFormatKML(CTTGPSLoggerEngine* aEngine);
	void ConstructL();
...
private:
    ...
    RBuf8 iWorkBuf8;
    RBuf iWorkBuf;
    CDesC8ArrayFlat iDescriptionItemArray;
    };

#endif // TTGPSLOGGERRECORDERFORMATKML_H
