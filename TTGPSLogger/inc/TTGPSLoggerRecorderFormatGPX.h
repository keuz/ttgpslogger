 ...
 */
#ifndef TTGPSLOGGERRECORDERFORMATGPX_H
#define TTGPSLOGGERRECORDERFORMATGPX_H
...
class CTTGPSLoggerRecorderFormatGPX : public CBase, public MTTGPSLoggerRecorderFormat
	{
public:
    static CTTGPSLoggerRecorderFormatGPX* NewL(CTTGPSLoggerEngine* aEngine);
    static CTTGPSLoggerRecorderFormatGPX* NewLC(CTTGPSLoggerEngine* aEngine);
	~CTTGPSLoggerRecorderFormatGPX();

private:
    CTTGPSLoggerRecorderFormatGPX(CTTGPSLoggerEngine* aEngine);
	void ConstructL();
...
#endif // TTGPSLOGGERRECORDERFORMATGPX_H
