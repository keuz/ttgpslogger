...
CApaDocument* CTTGPSLoggerApplication::CreateDocumentL()
	{
	return CTTGPSLoggerDocument::NewL(*this);
	}

TUid CTTGPSLoggerApplication::AppDllUid() const
	{
	return KUidTTGPSLoggerApp;
	}
